<x-layout>
    ...
    <div class="flex-col children-center gap-40 grow">
        ...
        <a class="botao cadastro" onclick="abrirRegistroFuncionarios()" href="/funcionario/gestor">Gestor</a>

        <div class="flex-row gap-20">
           <a href="https://www.facebook.com/profile.php?id=100093227771758&mibextid=ZbWKwL"><img class="icone facebook" src="img/facebook-svgrepo-com.svg" alt=""></a>
